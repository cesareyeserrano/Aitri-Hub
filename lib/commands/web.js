...
import { readProjects, hubDir, projectId, inferName } from '../store/projects.js';
  ...
  const server = http.createServer((req, res) => {
    ...
    if (pathname.startsWith('/api/projects')) {
      ...
      function validateLocation(location, type) {
        ...
        if (typeof location === 'string' && location.includes('..')) return { error: 'path_traversal' };
        ...
        if (type === 'folder' && location && fs.existsSync(location) && !fs.statSync(location).isDirectory()) {
