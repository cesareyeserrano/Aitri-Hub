...
function printNextSteps(iface) {
  ...
  console.log(`  ${dim}Scan a folder:         aitri-hub setup --scan /your/projects${reset}`);
  console.log(`  ${dim}Note: since Aitri v0.1.64, new projects are not auto-registered.${reset}`);
  console.log(`  ${dim}      Use 'aitri-hub setup' to register projects manually.${reset}`);
  console.log('');
  console.log(hr('═'));
  console.log('');
}
