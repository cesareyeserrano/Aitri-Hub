...
function validate(obj) {
  ...
  // FR-046: full pre-release versions (2.0.0-rc.159) are valid baselines.
  /** @aitri-trace FR-ID: FR-046, US-ID: US-046, AC-ID: AC-0461, AC-0462, TC-ID: TC-046h, TC-046f */
  if (typeof obj.reviewedUpTo !== 'string' || !parseSemver(obj.reviewedUpTo)) {
    return `reviewedUpTo is invalid (expected semver, optionally with a pre-release tag — got ${JSON.stringify(obj.reviewedUpTo)})`;
  }
