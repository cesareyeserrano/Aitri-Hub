...
const TEST_RESULTS_FILE = '04_TEST_RESULTS.json';

/**
 * Read and parse 04_TEST_RESULTS.json from a project directory.
 ...
 */
export function readTestSummary(projectDir, artifactsDir = 'spec') {
  const filePath = path.join(projectDir, artifactsDir, TEST_RESULTS_FILE);
