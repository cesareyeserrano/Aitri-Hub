...
const OFF_CHAIN = Object.freeze([
  { name: 'BUGS.json', kind: 'json' },
  { name: 'BACKLOG.json', kind: 'json' },
  { name: '05_PROOF_OF_COMPLIANCE.json', kind: 'json' },
  { name: 'BUILD_PLAN.md', kind: 'md' },
]);
...
const ARTIFACT_PHASE = Object.freeze({
  ...
  '05_TRACEABILITY.json': 5, '05_PROOF_OF_COMPLIANCE.json': 5,
  'AUDIT_REPORT.md': 0, 'BUGS.json': 0, 'BACKLOG.json': 0, 'BUILD_PLAN.md': 0,
});
