...
// parseInt returns NaN for garbage input, which silently breaks setInterval,
// setTimeout and server.listen. Coerce invalid/missing values to the fallback.
...
export const MAX_PROJECTS = parseIntEnv(process.env.AITRI_HUB_MAX_PROJECTS, 50);
export const REFRESH_MS = parseIntEnv(process.env.AITRI_HUB_REFRESH_MS, 5000);
export const REMOTE_REFRESH_MS = parseIntEnv(process.env.AITRI_HUB_REMOTE_REFRESH_MS, 60000);
export const GIT_TIMEOUT_MS = parseIntEnv(process.env.AITRI_HUB_GIT_TIMEOUT_MS, 5000);
export const STALE_HOURS = parseIntEnv(process.env.AITRI_HUB_STALE_HOURS, 72);
export const WEB_PORT = parseIntEnv(process.env.AITRI_HUB_PORT, 3000);
...
export const ALERT_TYPE = Object.freeze({
  ...
  // Bug tracking (FR-018)
  OPEN_BUGS: 'open-bugs',
  // Contract-catchup rc.159 (FR-044/FR-045)
  BUGS_PARSE_ERROR: 'bugs-parse-error',
  RESULTS_UNBOUND: 'results-unbound',
});
